...
- **Nunca incluir `Co-Authored-By: Claude` ni ninguna firma de autoría de IA en los mensajes de commit.** Los commits se firman únicamente con el autor configurado en git (`Alejandro`).
